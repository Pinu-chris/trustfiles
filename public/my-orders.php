                ...
                <div class="order-card">
                    ...
                    <div class="order-details">
                        ...
                        <div class="order-actions">
                            <a href="order-detail.html?id=${order.id}" class="btn btn-sm btn-outline">View Details</a>
                            ${order.status === 'pending' ? `
                                <button class="btn btn-sm btn-danger" onclick="cancelOrder(${order.id})">Cancel Order</button>
                            ` : ''}
                            ${order.status === 'completed' ? `
                                <a href="order-detail.html?id=${order.id}" class="btn btn-sm btn-primary">Leave Review</a>
                            ` : ''}
                        </div>
                    </div>
                </div>
