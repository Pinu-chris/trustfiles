...
/**
    ...
    {
        return isset($_SESSION[SessionKeys::USER_ID]) && 
               isset($_SESSION[SessionKeys::USER_NAME]);
    }
    ...
    public function logout()
    {
        ...
        if (ini_get("session.use_cookies")) {
            ...
            // Remove invalid values like "", spaces, etc.
            ...
            setcookie(
                ...
                $params["path"],
                $params["domain"],
                $params["secure"], // Uses the 'true' value from your config
                $params["httponly"]
            );
        }
